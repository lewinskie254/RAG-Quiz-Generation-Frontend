...
const ProgressCard = (props) => {
    ...
    const progressAmount = calculateScore();
    ...
    return (
        <div className="card">
            <div className="card-content">
                <div className="score-tab">
                    ...
                    <p className='score-paragraph'>
                        {props.outOfTerm}
                        <span className='out-of-tag'> {props.totalScore}</span>
                    </p>
                </div>
            ...
            <ProgressBar progressWidth={progressAmount} progressAmount={progressAmount} /> 
        </div>
    )
}
